...
CREATE DATABASE IF NOT EXISTS `rid` /*!40100 DEFAULT CHARACTER SET cp1251 */;
USE `rid`;
...
-- Дамп данных таблицы rid.image: ~0 rows (приблизительно)
...
/*!40000 ALTER TABLE `rids` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `rids` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `rid_author` DISABLE KEYS */;
INSERT INTO `rid_author` (`id_rid`, `id_author`) VALUES
	...
	(8, 10),
	(9, 11);
/*!40000 ALTER TABLE `rid_author` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `rid_image` DISABLE KEYS */;
/*!40000 ALTER TABLE `rid_image` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `rid_organization` DISABLE KEYS */;
INSERT INTO `rid_organization` (`id_rid`, `id_organization`) VALUES
	...
	(8, 10),
	(9, 11);
/*!40000 ALTER TABLE `rid_organization` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `status_rid` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `status_rid` ENABLE KEYS */;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` VIEW `wiev_documents` AS SELECT
